...
function getAnneesBissextiles($anneeDebut, $anneeFin) {
    ...
    for ($anneeCourante = $anneeDebut; $anneeCourante <= $anneeFin; $anneeCourante++) {
        if ((($anneeCourante % 4 == 0) && ($anneeCourante % 100 != 0)) || ($anneeCourante % 400 == 0)) {
            $lesAnneesBissextiles[] = $anneeCourante;
        }
    }
	...
	function getPeriode( $dateDebut , $dateFin ){
		...
		while( ! estApres( $dateCourante , $dateFin ) ){
			...
			$lesDates[] = $dateCourante;
			$dateCourante = getDemain($dateCourante);
		}
	...
	// Exercice 6 - Il y'a un mois
		...
		echo "15/04/2017... un mois plus tôt : " , getUnMoisAvant( "15/04/2017" ) , "\n" ;
		
		echo "\n" ;
		
		echo "15/12/2017... un mois plus tôt : " , getUnMoisAvant( "15/12/2017" ) , "\n" ;
